...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "user" | "queue" | "queueEntry"
    ...
    model: {
      ...
      QueueEntry: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.QueueEntryFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.QueueEntryAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type QueueOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "isActive" | "createdAt" | "businessId", ExtArgs["result"]["queue"]>
  ...
  export type QueueEntryOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "status" | "joinedAt" | "userId" | "queueId", ExtArgs["result"]["queueEntry"]>
  ...
  export interface QueueEntryDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more QueueEntries that matches the filter.
     * @param {QueueEntryFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const queueEntry = await prisma.queueEntry.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: QueueEntryFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a QueueEntry.
     * @param {QueueEntryAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const queueEntry = await prisma.queueEntry.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: QueueEntryAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface QueueEntryFieldRefs {
    ...
    readonly queueId: FieldRef<"QueueEntry", 'String'>
  }
   ...
   * QueueEntry findRaw
   */
  export type QueueEntryFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * QueueEntry aggregateRaw
   */
  export type QueueEntryAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type QueueEntryWhereInput = {
    ...
    queueId?: StringFilter<"QueueEntry"> | string
  ...
  export type QueueEntryWhereUniqueInput = Prisma.AtLeast<{
    id?: string
    userId_queueId?: QueueEntryUserIdQueueIdCompoundUniqueInput
    AND?: QueueEntryWhereInput | QueueEntryWhereInput[]
    OR?: QueueEntryWhereInput[]
    NOT?: QueueEntryWhereInput | QueueEntryWhereInput[]
    status?: EnumQueueStatusFilter<"QueueEntry"> | $Enums.QueueStatus
  ...
  export type QueueEntryScalarWhereWithAggregatesInput = {
    ...
    queueId?: StringWithAggregatesFilter<"QueueEntry"> | string
  }
  ...
  export type QueueCreateInput = {
    ...
    isActive?: boolean
    createdAt?: Date | string
    business: UserCreateNestedOneWithoutQueuesInput
  ...
  export type QueueUpdateInput = {
    ...
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    business?: UserUpdateOneRequiredWithoutQueuesNestedInput
  ...
  export type QueueEntryUserIdQueueIdCompoundUniqueInput = {
    userId: string
    queueId: string
  }
